...
6. النص المرفق أدناه قد يحتوي على كلمات مقلوبة الحروف أو معكوسة الاتجاه (مثال: "مويلا" تعني "اليوم"، و "ةم ايقلا" تعني "القيامة"). قم بإعادة ترتيب الكلمات والنصوص ذهنياً وفهمها بالشكل العربي الصحيح قبل صياغة الإجابة.
""".strip()
